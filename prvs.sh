...
function provisioning_start() {
 ...
 #   when-changed -r "${WORKSPACE}/stable-diffusion-webui/outputs" rclone copy "${WORKSPACE}/stable-diffusion-webui/outputs"  "gdrivevastai:vastai/outputs" --config  "/opt/stable-diffusion-webui/reclone-config.json" &
    ...
    when-changed -r "${WORKSPACE}/stable-diffusion-webui/log/images" rclone copy "${WORKSPACE}/stable-diffusion-webui/log/images"  "gdrivevastai:vastai/log/images" --config  "/opt/stable-diffusion-webui/reclone-config.json" --include "*.png"  &
